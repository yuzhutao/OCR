...
//    self.IDImageView.image = _IDImage;
    ...
    UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake(20, 150, [UIScreen mainScreen].bounds.size.width - 40, [UIScreen mainScreen].bounds.size.width - 80)];
    imageView.contentMode = UIViewContentModeScaleAspectFit;
    imageView.clipsToBounds = YES;
    imageView.image = _IDImage;
    [self.view addSubview:imageView];
    
    UILabel *infoLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(imageView.frame), self.view.frame.size.width, 40)];
    infoLabel.text = _textInfo;
