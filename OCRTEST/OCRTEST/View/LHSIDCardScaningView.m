...
-(void)addScaningWindow {
    ...
    CGFloat width = [UIScreen mainScreen].bounds.size.width - 40;//iPhone5or5cor5sorSE? 240: (iPhone6or6sor7? 270: 300);
    
    _IDCardScanningWindowLayer.bounds = (CGRect){CGPointZero, {width, width -40}};
...
//    center.x = CGRectGetMaxX(_IDCardScanningWindowLayer.frame);
    center.y = CGRectGetMinY(_IDCardScanningWindowLayer.frame) - 40;
    [self addTipLabelWithText:@"将图片置于此区域内，扫描" center:center];
